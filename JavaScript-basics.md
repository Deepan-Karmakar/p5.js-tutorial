...
```javascript
console.log("hello");
console.log("variables x, y values", x, y; // Ue default space separation of args
console.log("variable x, y values", x + " " + y); // Concatenate all message into a single string
```
