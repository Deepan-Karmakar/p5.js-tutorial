...
This `handleRequest()` method will serve a p5 sketch including an `index.html`, `sketch.js`, and `style.css`.  You can [see the full example here](https://github.com/lmccart/itp-creative-js/tree/master/week6/03_node_servep5).
...
See [the full example](https://github.com/lmccart/itp-creative-js/tree/master/week6/04_socket_server) for all the pieces working together.
...
__Adapted from tutorial written by Dan Shiffman for [ITP Creative JS](https://github.com/lmccart/itp-creative-js).__